...
class EncoderData
{
	...
	USHORT counterData[numChannels];
	USHORT counterDataPast[numChannels];
	USHORT positionDifferenceSHORT[numChannels];
	int positionDifferenceINT[numChannels];
	int turns;
	double ticksPerRev;
	float absolutePosition[numChannels];
...
public:
	...
	~EncoderData(void);
	float volatile outDisplayValuesFLOAT[8];
